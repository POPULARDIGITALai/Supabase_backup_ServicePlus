...
GRANT ALL ON TABLE "public"."Dent_Model_Damage" TO "anon";
GRANT ALL ON TABLE "public"."Dent_Model_Damage" TO "authenticated";
GRANT ALL ON TABLE "public"."Dent_Model_Damage" TO "service_role";
