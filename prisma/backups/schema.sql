...
CREATE TABLE IF NOT EXISTS "public"."Dent_Model_Damage" (
    "id" bigint NOT NULL,
    "created_at" timestamp with time zone DEFAULT "now"() NOT NULL,
    "lead_id" bigint,
    "image_url" "text",
...
ALTER TABLE "public"."Dent_Model_Damage" OWNER TO "postgres";


ALTER TABLE "public"."Dent_Model_Damage" ALTER COLUMN "id" ADD GENERATED BY DEFAULT AS IDENTITY (
    SEQUENCE NAME "public"."Dent_Model_Damage_id_seq"
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER TABLE ONLY "public"."Dent_Model_Damage"
    ADD CONSTRAINT "Dent_Model_Damage_pkey" PRIMARY KEY ("id");
...
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."Dent_Model_Damage" TO "anon";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."Dent_Model_Damage" TO "authenticated";
GRANT SELECT,INSERT,REFERENCES,DELETE,TRIGGER,TRUNCATE,UPDATE ON TABLE "public"."Dent_Model_Damage" TO "service_role";



GRANT ALL ON SEQUENCE "public"."Dent_Model_Damage_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."Dent_Model_Damage_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."Dent_Model_Damage_id_seq" TO "service_role";
